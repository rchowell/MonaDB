...
(function () {
  ...
  var PROGRAMS = [
    ...
    [ // Ranges
      ...
      [['events = db[', TXT], ['"events"', LIT], [']', TXT]],
      [['events.', TXT], ['range', KW], ['(start, stop)', TXT], ['     # half-open', COM]],
      [['events.', TXT], ['prefix', KW], ['(', TXT], ['"2026-08"', LIT], [')', TXT]],
      [['events.', TXT], ['first', KW], ['(), events.', TXT], ['last', KW], ['()', TXT]]
    ],
    [ // Models
      [['# bind a handle to a dataclass or pydantic model', COM]],
      [['users = db.', TXT], ['collection', KW], ['(', TXT], ['"users"', LIT], [', User)', TXT]],
      [['users[', TXT], ['"alice"', LIT], ['] = User(name=', TXT], ['"alice"', LIT], [', age=', TXT], ['30', LIT], [')', TXT]],
      [['users[', TXT], ['"alice"', LIT], [']', TXT], ['       # User(name=\'alice\', age=30)', COM]]
    ]
  ];
