...
pub(crate) fn get_table(env: &StorageInner, txn: &RoTxn, name: &str) -> Result<TableSchema> {
...
pub(crate) fn table_exists(env: &StorageInner, txn: &RoTxn, name: &str) -> Result<bool> {
...
pub(crate) fn next_row_id(env: &StorageInner, txn: &mut RwTxn, table_id: u32) -> Result<u64> {
...
fn next_table_id(env: &StorageInner, txn: &mut RwTxn) -> Result<u32> {
